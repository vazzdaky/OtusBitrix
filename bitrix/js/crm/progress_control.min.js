if(typeof BX.CrmDealStageManager==="undefined"){BX.CrmDealStageManager=function(){};BX.CrmDealStageManager.prototype={getInfos:function(t){if(!BX.type.isNotEmptyString(t)){t="category_0"}return BX.type.isArray(BX.CrmDealStageManager.infos[t])?BX.CrmDealStageManager.infos[t]:[]},isMultiType:function(){return true},getMessage:function(t){var e=BX.CrmDealStageManager.messages;return BX.type.isNotEmptyString(e[t])?e[t]:""},prepareDialogControls:function(t){return null}};BX.CrmDealStageManager.current=new BX.CrmDealStageManager;BX.CrmDealStageManager.infos={category_0:[{id:"NEW",name:"In Progress",sort:10,semantics:"process"},{id:"WON",name:"Is Won",sort:20,semantics:"success"},{id:"LOSE",name:"Is Lost",sort:30,semantics:"failure"}]};BX.CrmDealStageManager.messages={}}if(typeof BX.CrmDealRecurringStageManager==="undefined"){BX.CrmDealRecurringStageManager=function(){};BX.CrmDealRecurringStageManager.prototype={getInfos:function(t){return[]},isMultiType:function(){return false},getMessage:function(t){return""},prepareDialogControls:function(t){return null}};BX.CrmDealRecurringStageManager.current=new BX.CrmDealRecurringStageManager}if(typeof BX.CrmLeadStatusManager==="undefined"){BX.CrmLeadStatusManager=function(){this._admissionPromise=null;this._admissionResult=null};BX.CrmLeadStatusManager.prototype={getInfos:function(t){return BX.CrmLeadStatusManager.infos},isMultiType:function(){return false},getMessage:function(t){return BX.prop.getString(BX.CrmLeadStatusManager.messages,t,t)},admitChange:function(t,e){this._admissionPromise=new BX.Promise;this._admissionResult={succeeded:false,previousId:t,currentId:e};if(t===e||t!=="CONVERTED"){window.setTimeout(function(){this._admissionResult["succeeded"]=true;this._admissionPromise.fulfill(this._admissionResult)}.bind(this),0)}else{var i=BX.Crm.ConfirmationDialog.get("cancelLeadConversion");if(!i){i=BX.Crm.ConfirmationDialog.create("cancelLeadConversion",{title:this.getMessage("conversionCancellationTitle"),content:this.getMessage("conversionCancellationContent")})}i.open().then(function(t){if(this._admissionPromise&&this._admissionResult){this._admissionResult["succeeded"]=!BX.prop.getBoolean(t,"cancel",true);this._admissionPromise.fulfill(this._admissionResult)}}.bind(this))}return this._admissionPromise}};BX.CrmLeadStatusManager.current=new BX.CrmLeadStatusManager;BX.CrmLeadStatusManager.infos=[{id:"NEW",name:"Not Processed",sort:10,semantics:"process"},{id:"CONVERTED",name:"Converted",sort:20,semantics:"success"},{id:"JUNK",name:"Junk",sort:30,semantics:"failure"}];BX.CrmLeadStatusManager.messages={}}if(typeof BX.CrmLeadTerminationControl==="undefined"){BX.CrmLeadTerminationControl=function(){this._id="";this._settings=null;this._entityId="";this._enabled=true;this._schemeData=null;this._selector=null;this._permissionCheckCallback=null;this._showPermissionErrorCallback=null;this._dialogOpenListener=BX.delegate(this.onDialogOpen,this);this._dialogCloseListener=BX.delegate(this.onDialogClose,this)};BX.CrmLeadTerminationControl.prototype={initialize:function(t,e){this._id=t;this._settings=e?e:BX.CrmParamBag.create(null);this._entityId=parseInt(this.getSetting("entityId",0));this._enabled=this.getSetting("canConvert",true);this._schemeData=this.getSetting("conversionScheme",{});this._permissionCheckCallback=this.getSetting("permissionCheckCallback",null);this._showPermissionErrorCallback=this.getSetting("showPermissionErrorCallback",null)},getSetting:function(t,e){return this._settings.getParam(t,e)},setSetting:function(t,e){this._settings.setParam(t,e)},getId:function(){return this._id},getEntityId:function(){return this._entityId},isEnabled:function(){return this._enabled},prepareControlId:function(t){return(this._id+"_"+t).toLowerCase()},prepareDialogControls:function(t){var e={};var i=false;var s=t.getSetting("success");if(s){i=true;const t=BX.create("SPAN",{attrs:{id:this.prepareControlId("success_btn_wrapper"),className:"webform-small-button-separate-wrap"},children:[BX.create("SPAN",{attrs:{id:this.prepareControlId("success_btn_inner_wrapper"),className:"webform-small-button webform-small-button-accept"},children:[BX.create("SPAN",{text:this._schemeData["schemeCaption"]+": "}),BX.create("SPAN",{attrs:{id:this.prepareControlId("success_btn")},text:this._schemeData["schemeDescription"]})]}),BX.create("SPAN",{attrs:{id:this.prepareControlId("success_btn_menu"),className:"webform-small-button-right-part"}})]});if(this.isPermissionsCheckAvailable()&&!this._permissionCheckCallback()){i=false;BX.Dom.addClass(t,"--disabled");t.onclick=()=>{this._showPermissionErrorCallback()}}e.successButton=t}if(i){t.addOpenListener(this._dialogOpenListener);t.addCloseListener(this._dialogCloseListener)}return e},isPermissionsCheckAvailable(){return BX.type.isFunction(this._permissionCheckCallback)&&BX.type.isFunction(this._showPermissionErrorCallback)},onDialogOpen:function(t){if(this._selector){this._selector.release();this._selector=null}this._selector=this._tryCreateSelectorViaConversionExtension();if(!this._selector){this._selector=BX.CrmLeadConversionSchemeSelector.create(this.prepareControlId("conv_scheme_selector"),{typeId:this.getSetting("typeId",BX.CrmLeadConversionType.general),entityId:this._entityId,scheme:this._schemeData["schemeName"],containerId:this.prepareControlId("success_btn_inner_wrapper"),labelId:this.prepareControlId("success_btn"),buttonId:this.prepareControlId("success_btn_menu"),originUrl:this._schemeData["originUrl"],enableHint:false})}},_tryCreateSelectorViaConversionExtension:function(){if(!BX.Reflection.getClass("BX.Crm.Conversion.Manager")||!BX.Reflection.getClass("BX.Crm.Conversion.SchemeSelector")||!BX.Reflection.getClass("BX.Crm.Integration.Analytics.Dictionary")){return null}const t=this.getSetting("converterId",null);if(!t){return null}const e=BX.Crm.Conversion.Manager.Instance.getConverter(t);if(!e){console.error(`converter with id ${t} not found`);return null}const i=new BX.Crm.Conversion.SchemeSelector(e,{entityId:this._entityId,containerId:this.prepareControlId("success_btn_inner_wrapper"),labelId:this.prepareControlId("success_btn"),buttonId:this.prepareControlId("success_btn_menu"),analytics:{c_element:BX.Crm.Integration.Analytics.Dictionary.ELEMENT_TERMINATION_CONTROL}});i.enableAutoConversion();return i},onDialogClose:function(t){if(this._selector){this._selector.release();this._selector=null}t.removeOpenListener(this._dialogOpenListener);t.removeCloseListener(this._dialogCloseListener)}};BX.CrmLeadTerminationControl.create=function(t,e){var i=new BX.CrmLeadTerminationControl;i.initialize(t,e);return i}}if(typeof BX.CrmQuoteStatusManager==="undefined"){BX.CrmQuoteStatusManager=function(){};BX.CrmQuoteStatusManager.prototype={getInfos:function(t){return BX.CrmQuoteStatusManager.infos},isMultiType:function(){return false},getMessage:function(t){var e=BX.CrmQuoteStatusManager.messages;return BX.type.isNotEmptyString(e[t])?e[t]:""},prepareDialogControls:function(t){return null}};BX.CrmQuoteStatusManager.current=new BX.CrmQuoteStatusManager;BX.CrmQuoteStatusManager.infos=[{id:"DRAFT",name:"In Progress",sort:10,semantics:"process"},{id:"APPROVED",name:"Is Approved",sort:20,semantics:"success"},{id:"DECLAINED",name:"Is Declained",sort:30,semantics:"failure"}];BX.CrmQuoteStatusManager.messages={}}if(typeof BX.CrmOrderShipmentStatusManager==="undefined"){BX.CrmOrderShipmentStatusManager=function(){};BX.CrmOrderShipmentStatusManager.prototype={getInfos:function(t){return BX.CrmOrderShipmentStatusManager.infos},isMultiType:function(){return false},getMessage:function(t){var e=BX.CrmOrderShipmentStatusManager.messages;return BX.type.isNotEmptyString(e[t])?e[t]:""},prepareDialogControls:function(t){return null}};BX.CrmOrderShipmentStatusManager.current=new BX.CrmOrderShipmentStatusManager;BX.CrmOrderShipmentStatusManager.infos=[{id:"DN",name:"In Progress",sort:10,semantics:"process"},{id:"DF",name:"Deducted",sort:20,semantics:"success"}];BX.CrmOrderShipmentStatusManager.messages={}}if(typeof BX.CrmOrderStatusManager==="undefined"){BX.CrmOrderStatusManager=function(){this.dlg=null};BX.CrmOrderStatusManager.prototype={getSetting:function(t,e){return typeof BX.CrmOrderStatusManager.settings[t]!=="undefined"?BX.CrmOrderStatusManager.settings[t]:e},isMultiType:function(){return false},setSetting:function(t,e){BX.CrmOrderStatusManager.settings[t]=e},getInfos:function(t){return BX.CrmOrderStatusManager.infos},getMessage:function(t){var e=BX.CrmOrderStatusManager.messages;return BX.type.isNotEmptyString(e[t])?e[t]:""},prepareDialogControls:function(t){return null}};BX.CrmOrderStatusManager.current=new BX.CrmOrderStatusManager;BX.CrmOrderStatusManager.settings={};BX.CrmOrderStatusManager.statusInfoValues=[];BX.CrmOrderStatusManager.infos=[{id:"N",name:"In Progress",sort:10,semantics:"process"},{id:"F",name:"Is Paid",sort:20,semantics:"success"},{id:"D",name:"Is Dismiss",sort:30,semantics:"failure"}];BX.CrmOrderStatusManager.messages={};BX.CrmOrderStatusManager.failureDialogEventsBinded=false;BX.CrmOrderStatusManager.failureDialogEventsBind=function(){if(!BX.CrmOrderStatusManager.failureDialogEventsBinded){BX.CrmOrderStatusManager.failureDialogEventsBinded=true;BX.addCustomEvent("CrmProcessFailureDialogContentCreated",(function(t){var e=BX.CrmOrderStatusManager.current;var i=t.getEntityType();if(i==="ORDER"){var s=parseInt(t.getEntityId());var n=t.getWrapper();var r="crm_"+i+s+"_params";var a=r+"_failure";e.failureParamsId=a;if(n&&s>0&&i.length>0){var o=BX.CrmOrderStatusManager.statusInfoValues[s],l=BX.create("DIV",{attrs:{id:r},children:[BX.create("DIV",{attrs:{id:a,class:"crm-invoice-term-dialog-params"},children:[BX.create("SPAN",{attrs:{class:"comment-header"},text:e.getMessage("commentLabelText")+":"}),BX.create("TEXTAREA",{attrs:{class:"bx-crm-dialog-invoice-textarea",name:"REASON_CANCELED"},text:o["REASON_CANCELED"]?o["REASON_CANCELED"]:""})]})]});if(l)n.appendChild(l)}}}));BX.addCustomEvent("CrmProgressControlBeforeFailureDialogClose",(function(t,e){var i=e.getEntityType();if(i==="ORDER"){var s=BX.CrmOrderStatusManager.current;var n=BX(s.failureParamsId);s.saveParams={};if(n){var r=[];var a=BX.findChildren(n,{tag:"input"},true);if(a)r=r.concat(a);var o=BX.findChildren(n,{tag:"textarea"},true);if(o)r=r.concat(o);var l;for(var u in r){l=r[u].getAttribute("name");if(l)s.saveParams[l]=r[u].value}}}}));BX.addCustomEvent("CrmProgressControlBeforeSave",(function(t,e){if(t.getEntityType()!=="ORDER")return;var i=BX.CrmOrderStatusManager.current;if(BX.type.isPlainObject(i.saveParams)){var s=t.getEntityId();for(var n in i.saveParams){if(s>0)BX.CrmOrderStatusManager.statusInfoValues[s][n]=i.saveParams[n];e[n]=i.saveParams[n]}}e["STATE_SUCCESS"]=i.isSuccess?"Y":"N"}));BX.addCustomEvent("CrmProgressControlAfterSaveSucces",(function(t,e){if(t.getEntityType()!=="ORDER")return;if(BX.type.isNotEmptyString(e["ERROR"])&&BX.type.isNotEmptyString(e["STATUS_ID"])){t._currentStepId=e["STATUS_ID"];t._layout()}}))}}}if(typeof BX.CrmInvoiceStatusManager==="undefined"){BX.CrmInvoiceStatusManager=function(){this.dlg=null};BX.CrmInvoiceStatusManager.prototype={getSetting:function(t,e){return typeof BX.CrmInvoiceStatusManager.settings[t]!=="undefined"?BX.CrmInvoiceStatusManager.settings[t]:e},setSetting:function(t,e){BX.CrmInvoiceStatusManager.settings[t]=e},getInfos:function(t){return BX.CrmInvoiceStatusManager.infos},getMessage:function(t){var e=BX.CrmInvoiceStatusManager.messages;return BX.type.isNotEmptyString(e[t])?e[t]:""},prepareDialogControls:function(t){return null},_handleDateInputClick:function(t){var e=BX(this.dlgDateControlId);BX.calendar({node:BX(e),field:e,bTime:false,serverTime:this.getSetting("serverTime",""),bHideTimebar:true})},_handleDateImageMouseOver:function(t){BX.addClass(t.target,"calendar-icon-hover")},_handleDateImageMouseOut:function(t){if(!t){t=window.event}BX.removeClass(t.target,"calendar-icon-hover")}};BX.CrmInvoiceStatusManager.current=new BX.CrmInvoiceStatusManager;BX.CrmInvoiceStatusManager.settings={};BX.CrmInvoiceStatusManager.statusInfoValues=[];BX.CrmInvoiceStatusManager.infos=[{id:"N",name:"In Progress",sort:10,semantics:"process"},{id:"F",name:"Is Paid",sort:20,semantics:"success",hasParams:true},{id:"D",name:"Is Dismiss",sort:30,semantics:"failure"}];BX.CrmInvoiceStatusManager.messages={};BX.CrmInvoiceStatusManager.failureDialogEventsBinded=false;BX.CrmInvoiceStatusManager.failureDialogEventsBind=function(){if(!BX.CrmInvoiceStatusManager.failureDialogEventsBinded){BX.CrmInvoiceStatusManager.failureDialogEventsBinded=true;BX.addCustomEvent("CrmProcessFailureDialogContentCreated",(function(t){var e=BX.CrmInvoiceStatusManager.current;var i=t.getEntityType();if(i==="INVOICE"){var s=parseInt(t.getEntityId());var n=t.getWrapper();var r=t.getValue()===t.getSuccessValue();var a="crm_"+i+s+"_params";var o=a+"_success";var l=a+"_failure";var u="crm_"+i+s+"_date_success";var c="crm_"+i+s+"_date_fail";e.isSuccess=r;e.successParamsId=o;e.failureParamsId=l;e.dlgDateControlId=r?u:c;if(n&&s>0&&i.length>0){var h=BX.CrmInvoiceStatusManager.statusInfoValues[s];var d=null;d=BX.create("DIV",{attrs:{id:a},children:[BX.create("DIV",{attrs:{id:o,class:"crm-invoice-term-dialog-params",style:r?"":"display: none;"},children:[BX.create("TABLE",{children:[BX.create("TR",{children:[BX.create("TD",{class:"left-column",text:e.getMessage("dateLabelText")+":"}),BX.create("TD",{children:[BX.create("INPUT",{attrs:{className:"bx-crm-dialog-input"},props:{type:"text",id:u,name:"PAY_VOUCHER_DATE",value:h["PAY_VOUCHER_DATE"]?h["PAY_VOUCHER_DATE"]:BX.formatDate(null,BX.message("FORMAT_DATE"))},style:{width:"70px"},events:{click:BX.delegate(e._handleDateInputClick,e)}}),BX.create("A",{props:{href:"javascript:void(0);",title:e.getMessage("setDate")},children:[BX.create("IMG",{attrs:{src:e.getSetting("imagePath","")+"calendar.gif",className:"calendar-icon",alt:e.getMessage("setDate")},events:{click:BX.delegate(e._handleDateInputClick,e),mouseover:BX.delegate(e._handleDateImageMouseOver,e),mouseout:BX.delegate(e._handleDateImageMouseOut,e)}})]})]})]}),BX.create("TR",{children:[BX.create("TD",{class:"left-column",text:e.getMessage("payVoucherNumLabelText")+":"}),BX.create("TD",{children:[BX.create("INPUT",{attrs:{class:"bx-crm-dialog-input",type:"text",name:"PAY_VOUCHER_NUM",value:h["PAY_VOUCHER_NUM"]?h["PAY_VOUCHER_NUM"].substring(0,20):"",maxlength:20,size:20}})]})]})]}),BX.create("DIV",{attrs:{class:"separator"}}),BX.create("SPAN",{attrs:{class:"comment-header"},text:e.getMessage("commentLabelText")+":"}),BX.create("TEXTAREA",{attrs:{class:"bx-crm-dialog-invoice-textarea",name:"REASON_MARKED_SUCCESS"},text:h["REASON_MARKED"]?h["REASON_MARKED"]:""})]}),BX.create("DIV",{attrs:{id:l,class:"crm-invoice-term-dialog-params",style:r?"display: none;":""},children:[BX.create("TABLE",{children:[BX.create("TR",{children:[BX.create("TD",{class:"left-column",text:e.getMessage("dateLabelText")+":"}),BX.create("TD",{children:[BX.create("INPUT",{attrs:{className:"bx-crm-dialog-input"},props:{type:"text",id:c,name:"DATE_MARKED",value:h["DATE_MARKED"]?h["DATE_MARKED"]:BX.formatDate(null,BX.message("FORMAT_DATE"))},style:{width:"70px"},events:{click:BX.delegate(e._handleDateInputClick,e)}}),BX.create("A",{props:{href:"javascript:void(0);",title:e.getMessage("setDate")},children:[BX.create("IMG",{attrs:{src:e.getSetting("imagePath","")+"calendar.gif",className:"calendar-icon",alt:e.getMessage("setDate")},events:{click:BX.delegate(e._handleDateInputClick,e),mouseover:BX.delegate(e._handleDateImageMouseOver,e),mouseout:BX.delegate(e._handleDateImageMouseOut,e)}})]})]})]})]}),BX.create("DIV",{attrs:{class:"separator"}}),BX.create("SPAN",{attrs:{class:"comment-header"},text:e.getMessage("commentLabelText")+":"}),BX.create("TEXTAREA",{attrs:{class:"bx-crm-dialog-invoice-textarea",name:"REASON_MARKED"},text:h["REASON_MARKED"]?h["REASON_MARKED"]:""})]})]});if(d)n.appendChild(d)}}}));BX.addCustomEvent("CrmProcessFailureDialogValueChanged",(function(t,e){var i=BX.CrmInvoiceStatusManager.current;var s=t.getEntityType();if(s==="INVOICE"){var n=parseInt(t.getEntityId());var r=t.getWrapper();var a=e===t.getSuccessValue();var o="crm_"+s+n+"_params";var l=o+"_success";var u=o+"_failure";var c=BX(l);var h=BX(u);var d="crm_"+s+n+"_date_success";var g="crm_"+s+n+"_date_fail";i.isSuccess=a;i.dlgDateControlId=a?d:g;if(c)c.setAttribute("style",a?"":"display: none;");if(h)h.setAttribute("style",a?"display: none;":"")}}));BX.addCustomEvent("CrmProgressControlBeforeFailureDialogClose",(function(t,e){var i=e.getEntityType();if(i==="INVOICE"){var s=BX.CrmInvoiceStatusManager.current;var n=BX(s.isSuccess?s.successParamsId:s.failureParamsId);s.saveParams={};if(n){var r=[];var a=BX.findChildren(n,{tag:"input"},true);if(a)r=r.concat(a);var o=BX.findChildren(n,{tag:"textarea"},true);if(o)r=r.concat(o);var l;for(var u in r){l=r[u].getAttribute("name");if(l)s.saveParams[l]=r[u].value}}}}));BX.addCustomEvent("CrmProgressControlBeforeSave",(function(t,e){if(t.getEntityType()!=="INVOICE"){return}var i=BX.CrmInvoiceStatusManager.current;if(BX.type.isPlainObject(i.saveParams)){var s=t.getEntityId();var n;for(var r in i.saveParams){if(s>0){if(r==="REASON_MARKED_SUCCESS")n="REASON_MARKED";else n=r;BX.CrmInvoiceStatusManager.statusInfoValues[s][n]=i.saveParams[r]}e[r]=i.saveParams[r]}}e["STATE_SUCCESS"]=i.isSuccess?"Y":"N"}))}}}if(typeof BX.CrmItemStatusManager==="undefined"){BX.CrmItemStatusManager=function(){};BX.CrmItemStatusManager.prototype={getInfos:function(t){if(BX.CrmItemStatusManager.infos===[]){console.log("Error: CrmItemStatusManager has not default stages")}return BX.type.isArray(BX.CrmItemStatusManager.infos[t])?BX.CrmItemStatusManager.infos[t]:[]},isMultiType:function(){return false},getMessage:function(t){var e=BX.CrmItemStatusManager.messages;return BX.type.isNotEmptyString(e[t])?e[t]:""},prepareDialogControls:function(t){return null}};BX.CrmItemStatusManager.current=new BX.CrmItemStatusManager;BX.CrmItemStatusManager.messages={};BX.CrmItemStatusManager.infos=[]}if(typeof BX.CrmProgressManager==="undefined"){BX.CrmProgressManager=function(){};BX.CrmProgressManager.prototype={resolve:function(t){if(t===BX.CrmEntityType.enumeration.deal){return BX.CrmDealStageManager.current}else if(t===BX.CrmEntityType.enumeration.dealrecurring){return BX.CrmDealRecurringStageManager.current}else if(t===BX.CrmEntityType.enumeration.quote){return BX.CrmQuoteStatusManager.current}else if(t===BX.CrmEntityType.enumeration.lead){return BX.CrmLeadStatusManager.current}else if(t===BX.CrmEntityType.enumeration.order){return BX.CrmOrderStatusManager.current}else if(t===BX.CrmEntityType.enumeration.ordershipment){return BX.CrmOrderShipmentStatusManager.current}return null},isMultiType:function(t){var e=this.resolve(t);if(!e){return false}return BX.type.isFunction(e.isMultiType)&&e.isMultiType()}};BX.CrmProgressManager.current=new BX.CrmProgressManager}if(typeof BX.CrmProgressControl==="undefined"){BX.CrmProgressControl=function(){this._id="";this._settings=null;this._container=null;this._legendContainer=null;this._entityId=0;this._entityType=null;this._previousStepId="";this._currentStepId="";this._infoTypeId="";this._manager=null;this._stepInfos=null;this._steps=[];this._terminationControl=null;this._terminationDlg=null;this._failureDlg=null;this._isFrozen=false;this._isReadOnly=false;this.permissionChecker=null;this.isLoading=false;this.loadingNotificationMessage=null;this.throttleShowLoadingNotificationCallback=null;this._entityEditorDialog=null;this._externalEventHandler=null;this._entityConvertHandler=null;this._entityEditorDialogHandler=BX.delegate(this._onEntityEditorDialogClose,this);this._enableFillContainerBackground=false;this._enableCustomColors=false;this._defaultProcessColor="#ACE9FB";this._defaultSuccessSuccessColor="#DBF199";this._defaultFailureColor="#FFBEBD";this._analyticsData=null};BX.CrmProgressControl.prototype={initialize:function(t,e){this._id=t;this._settings=e?e:BX.CrmParamBag.create(null);this._container=BX(this.getSetting("containerId"));var i=this.getSetting("legendContainerId");if(BX.type.isNotEmptyString(i)){this._legendContainer=BX(i)}if(!BX.type.isElementNode(this._legendContainer)){this._legendContainer=BX.findNextSibling(this._container,{className:"crm-list-stage-bar-title"})}this._entityId=parseInt(this.getSetting("entityId",0));this._entityType=this.getSetting("entityType");this._currentStepId=this.getSetting("currentStepId");this._infoTypeId=this.getSetting("infoTypeId","");this.loadingNotificationMessage=this.getSetting("loadingNotificationMessage",null);this._enableCustomColors=this.getSetting("enableCustomColors");if(this._entityType==="DEAL"){this._manager=BX.CrmDealStageManager.current}else if(this._entityType==="LEAD"){this._manager=BX.CrmLeadStatusManager.current;this._terminationControl=BX.CrmLeadTerminationControl.create(this._id,BX.CrmParamBag.create({entityId:this._entityId,conversionScheme:this.getSetting("conversionScheme",null),canConvert:this.getSetting("canConvert",true),typeId:this.getSetting("conversionTypeId",BX.CrmLeadConversionType.general),converterId:this.getSetting("converterId",null),permissionCheckCallback:this.isHasPermissionToMoveSuccessStage.bind(this),showPermissionErrorCallback:this.showMissPermissionError.bind(this)}))}else if(this._entityType==="QUOTE"){this._manager=BX.CrmQuoteStatusManager.current}else if(this._entityType==="ORDER"){this._manager=BX.CrmOrderStatusManager.current}else if(this._entityType==="ORDER_SHIPMENT"){this._manager=BX.CrmOrderShipmentStatusManager.current}else if(this._entityType==="INVOICE"){this._manager=BX.CrmInvoiceStatusManager.current}else if(BX.CrmEntityType.isUseDynamicTypeBasedApproachByName(this._entityType)){this._manager=BX.CrmItemStatusManager.current}var s=this._stepInfos=this._manager.getInfos(this._infoTypeId);var n=this._findStepInfoIndex(this._currentStepId);var r=n>=0?s[n]:null;this._isReadOnly=this.getSetting("readOnly",false);this._isFrozen=this._isReadOnly||(r&&BX.type.isBoolean(r["isFrozen"])?r["isFrozen"]:false);for(var a=0;a<s.length;a++){var o=s[a];var l=this.getStepContainer(o["id"]);if(!l){continue}var u=parseInt(o["sort"]);this._steps.push(BX.CrmProgressStep.create(o["id"],BX.CrmParamBag.create({name:o["name"],hint:BX.type.isNotEmptyString(o["hint"])?o["hint"]:"",sort:u,isPassed:a<=n,isReadOnly:this._isReadOnly,control:this,semantics:o.semantics})))}this.adjustDisableOfSteps()},getSetting:function(t,e){return this._settings.getParam(t,e)},setSetting:function(t,e){this._settings.setParam(t,e)},getId:function(){return this._id},getEntityType:function(){return this._entityType},getEntityId:function(){return this._entityId},getCurrentStepId:function(){return this._currentStepId},getStepById:function(t){for(var e=0,i=this._steps.length;e<i;e++){var s=this._steps[e];if(s.getId()===t){return s}}return null},getPermissionChecker(){if(this.permissionChecker===null){const t=this._stepInfos??this._manager.getInfos(this._infoTypeId);this.permissionChecker=BX.Crm.Stage.PermissionChecker.createFromStageInfos(t)}return this.permissionChecker},isHasPermissionToMove(t){return this.getPermissionChecker().isHasPermissionToMove(this.getCurrentStepId(),t)},isHasPermissionToMoveTerminationStages(){return this.isHasPermissionToMoveSuccessStage()||this.isHasPermissionToMoveFailureStages()},isHasPermissionToMoveSuccessStage(){const t=!this._terminationControl||this._terminationControl.isEnabled();return t&&this.getPermissionChecker().isHasPermissionToMoveSuccessStage(this.getCurrentStepId())},isHasPermissionToMoveFailureStages(){return this.getPermissionChecker().isHasPermissionToMoveAtLeastOneFailureStage(this.getCurrentStepId())},showMissPermissionError(){this.getPermissionChecker().showMissPermissionError()},isFrozen:function(){return this._isFrozen},isReadOnly:function(){return this._isReadOnly},isDisableStep(t){if(this.isLoading){return true}if(["success","failure"].includes(t.getSemantics())){return!this.isHasPermissionToMoveTerminationStages()}return!this.isHasPermissionToMove(t.getId())},onExternalEvent:function(t){var e=BX.prop.getString(t,"key","");if(e!=="onCrmEntityConvert"){return}var i=BX.prop.getObject(t,"value",{});if(this._entityType===BX.prop.getString(i,"entityTypeName")&&this._entityId===BX.prop.getInteger(i,"entityId",0)){this._closeTerminationDialog();this._closeFailureDialog()}},onEntityConvert:function(t,e){if(this._entityType===BX.prop.getString(e,"entityTypeName")&&this._entityId===BX.prop.getInteger(e,"entityId",0)){this._closeTerminationDialog();this._closeFailureDialog()}},getStepContainer:function(t){return BX.type.isNotEmptyString(t)?BX.findChild(this._container,{tag:"DIV",class:"crm-stage-"+t.toLowerCase()},true):null},setCurrentStep:function(t){this._closeTerminationDialog();if(this.isLoading){this.throttleShowLoadingNotification();return}if(!t||this._isReadOnly||this._isFrozen||this._entityEditorDialog!==null){return}if(BX.type.isFunction(this._manager["admitChange"])){this._manager.admitChange(this._currentStepId,t.getId()).then(function(t){if(!BX.prop.getBoolean(t,"succeeded",false)){return}var e=this.getStepById(BX.prop.getString(t,"currentId",""));if(e){this.setupStep(e)}}.bind(this))}else{this.setupStep(t)}},setupStep(t){const e=this._findStepInfoIndex(t.getId());if(e<0){return}if(e===this._steps.length-1&&this._findStepInfoBySemantics("success")&&this._findStepInfoBySemantics("failure")){if(!this.isHasPermissionToMoveTerminationStages()){this.showMissPermissionError();return}this._openTerminationDialog();return}const i=t.getId();if(this._currentStepId===i){return}if(!this.isHasPermissionToMove(i)){this.showMissPermissionError();return}this._previousStepId=this._currentStepId;this._currentStepId=i;this._layout();this._save()},setCurrentStepId(t){if(this._currentStepId!==t){this._previousStepId=this._currentStepId;this._currentStepId=t;this._layout()}},adjustDisableOfSteps(){this._steps.forEach((t=>{this.isDisableStep(t)?t.setDisable():t.removeDisable()}))},getCurrentStepInfo:function(){var t=this._findStepInfoIndex(this._currentStepId);return t>=0?this._stepInfos[t]:null},getCurrentStepName:function(){const t=this.getCurrentStepInfo();return t?.name??null},isCustomColorsEnabled:function(){return this._enableCustomColors},setColor:function(t){if(!this._stepInfos[t]||!this._enableCustomColors){return}const e=this._container.querySelectorAll("td.crm-list-stage-bar-part");for(var i=0;i<e.length;i++){if(i>t){e[i].style.background=""}else{var s=this._stepInfos[t];var n=BX.type.isNotEmptyString(s["color"])?s["color"]:"";if(n===""){var r=BX.type.isNotEmptyString(s["semantics"])?s["semantics"]:"";if(r==="success"){n=this._defaultSuccessSuccessColor}else if(r==="failure"){n=this._defaultFailureColor}else{n=this._defaultProcessColor}}e[i].style.background=n}}},_layout:function(){var t=this._findStepInfoIndex(this._currentStepId);if(t<0){return}for(var e=0;e<this._steps.length;e++){this._steps[e].setPassed(e<=t)}this.setColor(t);var i=this._stepInfos[t];this._isFrozen=BX.type.isBoolean(i["isFrozen"])?i["isFrozen"]:false;var s=BX.type.isNotEmptyString(i["semantics"])?i["semantics"]:"";if(this._enableFillContainerBackground){this.prepareContainerBackground(s)}if(this._legendContainer){this._legendContainer.innerHTML=BX.util.htmlspecialchars(BX.type.isNotEmptyString(i["name"])?i["name"]:i["id"])}this.adjustDisableOfSteps()},prepareContainerBackground(t){if(t==="success"){if(this._enableCustomColors){this._container.style.background=stepInfo["color"]}else{BX.addClass(this._container,"crm-list-stage-end-good");BX.removeClass(this._container,"crm-list-stage-end-bad")}}else if(t==="failure"||t==="apology"){if(this._enableCustomColors){this._container.style.background=stepInfo["color"]}else{BX.removeClass(this._container,"crm-list-stage-end-good");BX.addClass(this._container,"crm-list-stage-end-bad")}}else{if(this._enableCustomColors){this._container.style.background=""}else{BX.removeClass(this._container,"crm-list-stage-end-good");BX.removeClass(this._container,"crm-list-stage-end-bad")}}},_openTerminationDialog(){this._enableStepHints(false);if(this._terminationDlg){this._terminationDlg.close();this._terminationDlg=null}const t=`${this._id}_TERMINATION`;const e=this._findAllStepInfoBySemantics("apology");this._terminationDlg=BX.CrmProcessTerminationDialog.create(t,BX.CrmParamBag.create({title:this._manager.getMessage("dialogTitle"),failureTitle:e.length>0?this._manager.getMessage("failureTitle"):"",anchor:this._container,success:this._findStepInfoBySemantics("success"),failure:this._findStepInfoBySemantics("failure"),apologies:e,callback:this._onTerminationDialogClose.bind(this),terminationControl:this._terminationControl,buttonPrepareCallback:this.terminationButtonPrepareCallback.bind(this)}));this._terminationDlg.open();if(!this._externalEventHandler){this._externalEventHandler=this.onExternalEvent.bind(this);BX.addCustomEvent(window,"onLocalStorageSet",this._externalEventHandler)}if(!this._entityConvertHandler){this._entityConvertHandler=this.onEntityConvert.bind(this);BX.addCustomEvent(window,"Crm.EntityConverter.Converted",this._entityConvertHandler)}},_closeTerminationDialog:function(){if(!this._terminationDlg){return}this._terminationDlg.close(false);this._terminationDlg=null;this._enableStepHints(true);if(this._externalEventHandler){BX.removeCustomEvent(window,"onLocalStorageSet",this._externalEventHandler);this._externalEventHandler=null}},_onTerminationDialogClose(dialog,params){if(this._terminationDlg!==dialog){return}if(BX?.Crm?.Integration?.Analytics){this._analyticsData=BX.Crm.Integration.Analytics.Builder.Entity.CloseEvent.createDefault(this.getEntityType(),this.getEntityId()).setSubSection(BX.Crm.Integration.Analytics.Dictionary.SUB_SECTION_LIST).setElement(BX.Crm.Integration.Analytics.Dictionary.ELEMENT_GRID_PROGRESS_BAR).buildData();this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_ATTEMPT)}this._closeTerminationDialog();let stepId=BX.type.isNotEmptyString(params.result)?params.result:"";const index=this._findStepInfoIndex(stepId);if(index<0){return}let openFailureDialog=false;const info=this._stepInfos[index];const failure=this._findStepInfoBySemantics("failure");if(failure&&failure.id===stepId){openFailureDialog=true;if(!this.isHasPermissionToMoveFailureStages()){this.showMissPermissionError();this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_ERROR_PERMISSIONS);return}if(!this.isHasPermissionToMove(stepId)){const t=this._findAllStepInfoBySemantics("apology").find((t=>this.isHasPermissionToMove(t.id)));stepId=t.id}}else if(info.semantics==="success"){if(!this.isHasPermissionToMove(stepId)){this.showMissPermissionError();this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_ERROR_PERMISSIONS);return}if(typeof info.hasParams!=="undefined"&&info.hasParams===true){openFailureDialog=true}else{const finalScript=this.getSetting("finalScript","");if(finalScript!==""){this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_SUCCESS);eval(finalScript);return}const finalUrl=this.getSetting("finalUrl","");if(finalUrl!==""){this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_SUCCESS);window.location=finalUrl;return}}}this._previousStepId=this._currentStepId;this._currentStepId=stepId;if(openFailureDialog){this._openFailureDialog();return}this._layout();this._save()},terminationButtonPrepareCallback(t,e){if(this.isHasPermissionToMove(e.id)){return}if(e.semantics==="failure"&&this.isHasPermissionToMoveFailureStages()){return}BX.Dom.addClass(t,"--disabled")},_openFailureDialog:function(){this._enableStepHints(false);if(this._failureDlg){this._failureDlg.close();this._failureDlg=null}const t=this._findStepInfoIndex(this._currentStepId);const e=t>=0?this._stepInfos[t]:null;const i=e?e.id:"";const s=this._findAllStepInfoBySemantics("apology");const n=`${this._id}_FAILURE`;this._failureDlg=BX.CrmProcessFailureDialog.create(n,BX.CrmParamBag.create({entityType:this._entityType,entityId:this._entityId,initValue:i,failureTitle:s.length>0?this._manager.getMessage("failureTitle"):"",selectorTitle:this._manager.getMessage("selectorTitle"),anchor:this._container,success:this._findStepInfoBySemantics("success"),failure:this._findStepInfoBySemantics("failure"),apologies:s,callback:this._onFailureDialogClose.bind(this)}));BX.addCustomEvent("CrmProcessFailureDialogContentCreated",this.onCrmProcessFailureDialogContentCreated.bind(this));this._failureDlg.open();if(!this._externalEventHandler){this._externalEventHandler=BX.delegate(this.onExternalEvent,this);BX.addCustomEvent(window,"onLocalStorageSet",this._externalEventHandler)}},_closeFailureDialog:function(){if(!this._failureDlg){return}this._failureDlg.close(false);this._failureDlg=null;this._enableStepHints(true);if(this._externalEventHandler){BX.removeCustomEvent(window,"onLocalStorageSet",this._externalEventHandler);this._externalEventHandler=null}},_onFailureDialogClose(dialog,params){if(this._failureDlg!==dialog){return}BX.onCustomEvent(this,"CrmProgressControlBeforeFailureDialogClose",[this,this._failureDlg]);this._closeFailureDialog();const bid=BX.type.isNotEmptyString(params.bid)?params.bid:"";if(bid!=="accept"){this._currentStepId=this._previousStepId;return}const id=BX.type.isNotEmptyString(params.result)?params.result:"";const index=this._findStepInfoIndex(id);if(index<0){return}if(!this.getPermissionChecker().isHasPermissionToMove(this._previousStepId,id)){this.showMissPermissionError();this._currentStepId=this._previousStepId;return}const info=this._stepInfos[index];if(info.semantics==="success"){const finalScript=this.getSetting("finalScript","");if(finalScript!==""){eval(finalScript);return}const finalUrl=this.getSetting("finalUrl","");if(finalUrl!==""){window.location=finalUrl;return}const verboseMode=Boolean(this.getSetting("verboseMode",false));if(verboseMode){this._openTerminationDialog();return}}this._currentStepId=info.id;this._layout();this._save()},onCrmProcessFailureDialogContentCreated(t,e){if(this._failureDlg!==t){return}const i=this._previousStepId??this.getCurrentStepId();const s=e.querySelectorAll(".crm-list-end-deal-button-wrapper");s.forEach((t=>{const e=t.querySelector("input");if(!e){return}const s=e.value;if(this.getPermissionChecker().isHasPermissionToMove(i,s)){return}BX.Dom.addClass(t,"--disabled");e.onclick=t=>{this.showMissPermissionError();t.preventDefault()}}))},_save(){var t=this.getSetting("serviceUrl");var e=this.getCurrentStepId();var i=this.getEntityType();var s=this.getEntityId();if(t===""||e===""||i===""||s<=0){return}if(BX?.Crm?.Integration?.Analytics){const t=this._stepInfos[this._findStepInfoIndex(e)].semantics;if(t==="apology"||t==="failure"){this._analyticsData.c_element=BX.Crm.Integration.Analytics.Dictionary.ELEMENT_LOSE_BUTTON;this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_ATTEMPT)}else if(t==="success"){this._analyticsData.c_element=BX.Crm.Integration.Analytics.Dictionary.ELEMENT_WON_BUTTON;this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_ATTEMPT)}else{this._analyticsData=null}}this.setLoading(true);if(BX.CrmEntityType.isUseDynamicTypeBasedApproachByName(i)){BX.ajax.runAction(t,{data:{entityTypeId:BX.CrmEntityType.resolveId(i),id:s,fields:{stageId:this.getCurrentStepId()}}}).then(function(t){this._onSaveRequestSuccess(t.data)}.bind(this)).catch(function(t){var e=false;var i={};var s="";for(var n in t.errors){if(t.errors[n].code==="CRM_FIELD_ERROR_REQUIRED"){i[t.errors[n].customData.fieldName]=t.errors[n].message;e=true}if(s===""){s=t.errors[n].message}else{s=s+", "+t.errors[n].message}}var r={CHECK_ERRORS:i,ERROR:s,ID:this.getEntityId(),TYPE:this.getEntityType(),VALUE:this.getCurrentStepId()};if(e){this._onSaveRequestSuccess(r)}else{console.log(s);this._onSaveRequestFailure(r)}}.bind(this))}else{var n={ACTION:"SAVE_PROGRESS",VALUE:e,TYPE:i,ID:s,sessid:BX.bitrix_sessid()};BX.onCustomEvent(this,"CrmProgressControlBeforeSave",[this,n]);BX.ajax({url:t,method:"POST",dataType:"json",data:n,onsuccess:BX.delegate(this._onSaveRequestSuccess,this),onfailure:BX.delegate(this._onSaveRequestFailure,this)})}},_onSaveRequestSuccess:function(t){this.setLoading(false);var e=BX.prop.getObject(t,"CHECK_ERRORS",null);if(e){this._openEntityEditorDialog({title:this._manager.getMessage("checkErrorTitle"),helpData:{text:this._manager.getMessage("checkErrorHelp"),code:this._manager.getMessage("checkErrorHelpArticleCode")},fieldNames:Object.keys(e),initData:BX.prop.getObject(t,"EDITOR_INIT_DATA",null),context:BX.prop.getObject(t,"CONTEXT",null),isController:BX.CrmEntityType.isUseFactoryBasedApproachByName(this.getEntityType()),stageId:BX.prop.getString(t,"VALUE",null)});if(this._analyticsData){this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_ERROR)}return}BX.onCustomEvent(this,"CrmProgressControlAfterSaveSucces",[this,t]);BX.CrmProgressControl._synchronize(this);if(this._analyticsData){this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_SUCCESS)}},_onSaveRequestFailure:function(t){this.setLoading(false);if(this._analyticsData){this._registerAnalyticsCloseEvent(BX.Crm.Integration.Analytics.Dictionary.STATUS_ERROR)}BX.onCustomEvent(self,"CrmProgressControlAfterSaveFailed",[this,t])},_openEntityEditorDialog:function(t){BX.Crm.PartialEditorDialog.close("progressbar-entity-editor");this._entityEditorDialog=BX.Crm.PartialEditorDialog.create("progressbar-entity-editor",{title:BX.prop.getString(t,"title","Please fill in all required fields"),entityTypeName:this._entityType,entityId:this._entityId,fieldNames:BX.prop.getArray(t,"fieldNames",[]),helpData:BX.prop.getObject(t,"helpData",null),context:BX.prop.getObject(t,"context",null),isController:BX.prop.getBoolean(t,"isController",false),stageId:BX.prop.getString(t,"stageId",null)});window.setTimeout(function(){this._entityEditorDialog.open();BX.addCustomEvent(window,"Crm.PartialEditorDialog.Close",this._entityEditorDialogHandler)}.bind(this),150)},_onEntityEditorDialogClose:function(t,e){if(!(this._entityType===BX.prop.getString(e,"entityTypeName",0)&&this._entityId===BX.prop.getInteger(e,"entityId",0))){return}this._entityEditorDialog=null;BX.removeCustomEvent(window,"Crm.PartialEditorDialog.Close",this._entityEditorDialogHandler);if(BX.prop.getBoolean(e,"isCancelled",true)&&this._previousStepId!==""){var i=this._findStepInfoIndex(this._previousStepId);if(i>=0){this._currentStepId=this._previousStepId;this._previousStepId="";this._layout()}}},_findStepInfoBySemantics:function(t){var e=this._stepInfos;for(var i=0;i<e.length;i++){var s=e[i];var n=BX.type.isNotEmptyString(s["semantics"])?s["semantics"]:"";if(t===n){return s}}return null},_findAllStepInfoBySemantics:function(t){var e=[];var i=this._stepInfos;for(var s=0;s<i.length;s++){var n=i[s];var r=BX.type.isNotEmptyString(n["semantics"])?n["semantics"]:"";if(t===r){e.push(n)}}return e},_findStepInfoIndex:function(t){var e=this._stepInfos;for(var i=0;i<e.length;i++){if(e[i]["id"]===t){return i}}return-1},_enableStepHints:function(t){for(var e=0;e<this._steps.length;e++){this._steps[e].enableHint(t)}},_registerAnalyticsCloseEvent(t){this._analyticsData.status=t;BX.UI.Analytics.sendData(this._analyticsData)},setLoading(t){if(this.isLoading===t){return}this.isLoading=t;this.adjustDisableOfSteps()},showLoadingNotification(){if(!this.loadingNotificationMessage){return}const t=BX.Text.encode(this.getCurrentStepName());BX.UI.Notification.Center.notify({content:this.loadingNotificationMessage.replace("#stage#",t),autoHideDelay:3e3})},throttleShowLoadingNotification(){if(this.throttleShowLoadingNotificationCallback===null){this.throttleShowLoadingNotificationCallback=BX.throttle(this.showLoadingNotification.bind(this),300)}this.throttleShowLoadingNotificationCallback()}};BX.CrmProgressControl.items={};BX.CrmProgressControl.create=function(t,e){var i=new BX.CrmProgressControl;i.initialize(t,e);this.items[t]=i;return i};BX.CrmProgressControl._synchronize=function(t){var e=t.getEntityType();var i=t.getEntityId();for(var s in this.items){if(!this.items.hasOwnProperty(s)){continue}var n=this.items[s];if(n===t){continue}if(n.getEntityType()===e&&n.getEntityId()===i){n.setCurrentStepId(t.getCurrentStepId())}}}}if(typeof BX.CrmProgressStep==="undefined"){BX.CrmProgressStep=function(){this._id="";this._settings=null;this._control=null;this._container=null;this._name="";this._hint="";this._isPassed=false;this._isReadOnly=false;this._enableHint=true;this._hintPopup=null;this._hintPopupTimeoutId=null;this.isDisabled=false;this.semantics=null};BX.CrmProgressStep.prototype={initialize(t,e){this._id=t;this._settings=e||BX.CrmParamBag.create(null);this._control=this.getSetting("control");this._container=this._control.getStepContainer(this._id);this._name=this.getSetting("name");this._hint=this.getSetting("hint","");this._isPassed=this.getSetting("isPassed",false);this._isReadOnly=this.getSetting("isReadOnly",false);this.semantics=this.getSetting("semantics","");if(!this._isReadOnly){BX.bind(this._container,"mouseover",BX.delegate(this._onMouseOver,this));BX.bind(this._container,"mouseout",BX.delegate(this._onMouseOut,this));BX.bind(this._container,"click",BX.delegate(this._onClick,this))}},getId:function(){return this._id},getName:function(){return this._name},getSetting:function(t,e){return this._settings.getParam(t,e)},isPassed:function(){return this._isPassed},setPassed:function(t){t=!!t;if(this._isPassed===t){return}this._isPassed=t;if(!this._control.isCustomColorsEnabled()){var e=BX.findParent(this._container,{class:"crm-list-stage-bar-part"});if(t){BX.addClass(e,"crm-list-stage-passed")}else{BX.removeClass(e,"crm-list-stage-passed")}}},isReadOnly:function(){return this._isReadOnly},isHintEnabled:function(){return this._enableHint},enableHint:function(t){t=!!t;if(this._enableHint===t){return}this._enableHint=t;if(!t){this.hideStepHint()}},getSemantics(){return this.semantics},displayStepHint(t){if(!this._enableHint||this._hintPopup){return}const e=this._hint===""?this._name:this._hint;const i=BX.Tag.render`
				<span class="crm-list-bar-popup-text">${BX.util.htmlspecialchars(e)}</span>
			`;if(this.isDisable()){BX.Dom.style(i,"opacity","0.6")}const s=BX.pos(this._container);const n=`step-hint-${this.getId()}`;this._hintPopup=BX.PopupWindowManager.create(n,t,{className:"crm-list-bar-popup-table",content:i,offsetLeft:s.width/2,offsetTop:5,angle:{position:"bottom",offset:0}});this._hintPopup.show()},hideStepHint(){if(!this._hintPopup){return}this._hintPopup.close();this._hintPopup.destroy();this._hintPopup=null},_onClick:function(t){if(!this._isReadOnly){this._control.setCurrentStep(this)}t.stopPropagation()},_onMouseOver(t){if(this._hintPopupTimeoutId!==null){window.clearTimeout(this._hintPopupTimeoutId)}const e=t||window.event;const i=e.target||e.srcElement;this._hintPopupTimeoutId=window.setTimeout((()=>{this._hintPopupTimeoutId=null;this.displayStepHint(i)}),300)},_onMouseOut:function(t){if(this._hintPopupTimeoutId!==null){window.clearTimeout(this._hintPopupTimeoutId)}if(!this._enableHint){return}var e=this;this._hintPopupTimeoutId=window.setTimeout((function(){e._hintPopupTimeoutId=null;e.hideStepHint()}),300)},isDisable(){return this.isDisabled},setDisable(){if(this.isDisabled){return}this.isDisabled=true;const t=this._container.parentElement;BX.Dom.addClass(t,"--disabled")},removeDisable(){if(!this.isDisabled){return}this.isDisabled=false;const t=this._container.parentElement;BX.Dom.removeClass(t,"--disabled")}};BX.CrmProgressStep.create=function(t,e){var i=new BX.CrmProgressStep;i.initialize(t,e);return i}}if(typeof BX.CrmProcessTerminationDialog==="undefined"){BX.CrmProcessTerminationDialog=function(){this._id="";this._settings=null;this._terminationControl=null;this._popup=null;this._wrapper=null;this._openNotifier=null;this._closeNotifier=null;this._result="";this._enableCallback=true};BX.CrmProcessTerminationDialog.prototype={initialize:function(t,e){this._id=t;this._settings=e?e:BX.CrmParamBag.create(null);this._terminationControl=this.getSetting("terminationControl",null);this._openNotifier=BX.CrmNotifier.create(this);this._closeNotifier=BX.CrmNotifier.create(this)},getSetting:function(t,e){return this._settings.getParam(t,e)},getId:function(){return this._id},getResult:function(){return this._result},open:function(){if(!this._popup){this._popup=new BX.PopupWindow(this._id,this.getSetting("anchor"),{closeByEsc:true,autoHide:false,offsetLeft:-50,closeIcon:true,className:"crm-list-end-deal",content:this._prepareContent(),events:{onPopupShow:BX.delegate(this._onPopupShow,this),onPopupClose:BX.delegate(this._onPopupClose,this)}})}this._popup.show()},addOpenListener:function(t){this._openNotifier.addListener(t)},removeOpenListener:function(t){this._openNotifier.removeListener(t)},close:function(t){this._enableCallback=!!t;if(this._popup){this._popup.close()}},addCloseListener:function(t){this._closeNotifier.addListener(t)},removeCloseListener:function(t){this._closeNotifier.removeListener(t)},_onPopupShow:function(){this._openNotifier.notify()},_onPopupClose:function(){if(this._popup){this._popup.destroy();this._popup=null}this._closeNotifier.notify();this._executeCallback()},_prepareContent(){this._wrapper=BX.Tag.render`<div></div>`;const t=BX.Tag.render`
				<table class='crm-list-end-deal-block' cellspacing="0" cellpadding="0" border="0"></table>
			`;BX.Dom.append(t,this._wrapper);let e=t.insertRow(-1).insertCell(-1);e.className="crm-list-end-deal-text";e.innerHTML=this.getSetting("title","");e=t.insertRow(-1).insertCell(-1);e.className="crm-list-end-deal-buttons-block";["success","failure"].forEach((t=>{const i=this.getButtonBySemantics(t);if(i!==null){BX.Dom.append(i,e)}}));return this._wrapper},getButtonBySemantics(t){if(!["success","failure"].includes(t)){return null}const e=this.getControls();const i=`${t}Button`;if(BX.type.isElementNode(e[i])){return e[i]}const s=this.getSetting(t,null);if(!s){return null}const n=this.getTitleByInfo(s);const r=t==="success"?"accept":"decline";const a=BX.Tag.render`
