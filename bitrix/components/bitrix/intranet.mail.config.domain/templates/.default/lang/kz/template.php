...
$MESS["INTR_MAIL_DOMAIN_REG_CONFIRM_TEXT"] = "Қосылғаннан кейін сіз ағымдағы доменнің атын өзгерте алмайсыз<br> немесе жаңасын ала алмайсыз, өйткені сіз Битрикс24<br>үшін тек бір доменді тіркей аласыз.<br><br>Егер таңдалған атауы <b>#DOMAIN#</b> дұрыс болып табылса, домен қосылуын растаңыз.";
