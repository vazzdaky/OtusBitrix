/* eslint-disable */
(function (exports,main_core,main_date,biconnector_apacheSupersetDashboardManager,main_core_events,ui_dialogs_messagebox,biconnector_apacheSupersetAnalytics,ui_entitySelector,ui_tour,biconnector_entitySelector) {
	'use strict';
	  ...
	  babelHelpers.createClass(SupersetDashboardGridManager, [{
	      ...
	      babelHelpers.classPrivateFieldGet(this, _dashboardManager).restartDashboardImport(dashboardId).then(function (response) {
	        ...
	        try {
	          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
	            ...
	            _this.updateDashboardStatus(restartedDashboardId, biconnector_apacheSupersetDashboardManager.DashboardManager.DASHBOARD_STATUS_LOAD);
	          }
	        } catch (err) {
	          _iterator2.e(err);
	        } finally {
	    ...
	    value: function duplicateDashboard(dashboardId) {
	      ...
	      return babelHelpers.classPrivateFieldGet(this, _dashboardManager).duplicateDashboard(dashboardId).then(function (response) {
	        ...
	        gridRealtime.addRow({
	          ...
	          insertAfter: babelHelpers.classPrivateFieldGet(_this2, _lastPinnedRowId)
	        });
	    ...
	    value: function publish(dashboardId) {
	      ...
	      babelHelpers.classPrivateFieldGet(this, _dashboardManager).toggleDraft(dashboardId, true).then(function () {
	        _this3.updateDashboardStatus(dashboardId, biconnector_apacheSupersetDashboardManager.DashboardManager.DASHBOARD_STATUS_READY);
	        babelHelpers.classPrivateFieldGet(_this3, _grid).updateRow(dashboardId);
	      })["catch"](function () {
	        BX.UI.Notification.Center.notify({
	    ...
	    value: function setDraft(dashboardId) {
	      ...
	      babelHelpers.classPrivateFieldGet(this, _dashboardManager).toggleDraft(dashboardId, false).then(function () {
	        _this4.updateDashboardStatus(dashboardId, biconnector_apacheSupersetDashboardManager.DashboardManager.DASHBOARD_STATUS_DRAFT);
	        babelHelpers.classPrivateFieldGet(_this4, _grid).updateRow(dashboardId, null, null, function (result) {
	          _classPrivateMethodGet(_this4, _showDraftGuide, _showDraftGuide2).call(_this4, babelHelpers.classPrivateFieldGet(_this4, _grid).getRows().getById(dashboardId).node);
	        });
	      })["catch"](function () {
	        BX.UI.Notification.Center.notify({
	      ...
	      var messageBox = new ui_dialogs_messagebox.MessageBox({
	        ...
	        buttons: [new BX.UI.Button({
	          ...
	          onclick: function onclick(button) {
	            button.setWaiting();
	            babelHelpers.classPrivateFieldGet(_this5, _dashboardManager).deleteDashboard(dashboardId).then(function () {
	              _this5.getGrid().reload();
	              messageBox.close();
	            })["catch"](function (response) {
	              messageBox.close();
	              if (response.errors) {
	...
	function _subscribeToEvents2() {
	  ...
	  main_core_events.EventEmitter.subscribe('BIConnector.CreateForm:onDashboardCreated', function (event) {
	    _classPrivateMethodGet(_this12, _onNewDashboardCreated, _onNewDashboardCreated2).call(_this12, event);
	  });
	}
	...
	function _onNewDashboardCreated2(event) {
	  ...
	  _classPrivateMethodGet(this, _initHints, _initHints2).call(this);
	  setTimeout(function () {
	    _classPrivateMethodGet(_this13, _showDraftGuide, _showDraftGuide2).call(_this13, babelHelpers.classPrivateFieldGet(_this13, _grid).getRows().getBodyFirstChild().node);
	  }, 1200);
	}
...
}((this.window = this.window || {}),BX,BX.Main,BX.BIConnector,BX.Event,BX.UI.Dialogs,BX.BIConnector,BX.UI.EntitySelector,BX.UI.Tour,BX.BIConnector.EntitySelector));
