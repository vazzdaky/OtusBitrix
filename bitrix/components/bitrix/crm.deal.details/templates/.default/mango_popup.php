			...
			BX.ready(function() {
				...
				if (timelineItem)
				{
					...
					BX.message({
						...
						'CRM_DEAL_MANGO_NOTIFICATION_TEXT': '<?=\Bitrix\Crm\Integration\Market\Label::isRenamedMarket() ? GetMessageJS('CRM_DEAL_MANGO_NOTIFICATION_TEXT_MSGVER_1') : GetMessageJS('CRM_DEAL_MANGO_NOTIFICATION_TEXT')?>',
