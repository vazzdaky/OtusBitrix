...
CREATE TABLE IF NOT EXISTS b_crm_webform (
  ...
  IS_BOOKING_FORM char(1) NOT NULL DEFAULT 'N',
  PRIMARY KEY (ID)
);
...
CREATE INDEX ix_b_crm_act_ping_queue_ping_datetime ON b_crm_act_ping_queue (ping_datetime);
...
CREATE TABLE IF NOT EXISTS b_crm_copilot_call_assessment_availability (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  ASSESSMENT_ID int NOT NULL,
  START_POINT timestamp DEFAULT NULL,
  END_POINT timestamp DEFAULT NULL,
  WEEKDAY_TYPE varchar(20) DEFAULT NULL,
  CREATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (ID)
);
CREATE INDEX ix_b_crm_copilot_call_assessment_availability_assessment_id ON b_crm_copilot_call_assessment_availability (assessment_id);
...
CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_segment (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  TITLE varchar(255) NOT NULL,
  PROMPT text NOT NULL,
  IS_ENABLED char(1) NOT NULL DEFAULT 'Y',
  CODE varchar(30),
  ENTITY_TYPE_ID int NOT NULL DEFAULT 2,
  ENTITY_CATEGORY_ID int NOT NULL DEFAULT 0,
  ENTITY_STAGE_ID varchar(50) NOT NULL DEFAULT '',
  ENTITY_TITLE_PATTERN varchar(255),
  CALL_ASSESSMENT_ID int,
  IS_AI_ENABLED varchar(1) NOT NULL DEFAULT 'Y',
  CLIENT_FOUND int,
  CLIENT_COVERAGE smallint,
  CREATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UPDATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CREATED_BY_ID int NOT NULL DEFAULT 0,
  UPDATED_BY_ID int NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_job (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE INDEX ix_b_crm_repeat_sale_job_segment_id ON b_crm_repeat_sale_job (segment_id);

CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_queue (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  JOB_ID int NOT NULL,
  IS_ONLY_CALC varchar(1) NOT NULL DEFAULT 'N',
  STATUS int NOT NULL,
  LAST_ENTITY_TYPE_ID int,
  LAST_ITEM_ID int,
  LAST_ASSIGNMENT_ID int,
  ITEMS_COUNT int NOT NULL DEFAULT 0,
  HANDLER_TYPE_ID int NOT NULL,
  RETRY_COUNT int NOT NULL DEFAULT 0,
  HASH varchar(32),
  PARAMS text,
  CREATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX ix_b_crm_repeat_sale_queue_job_id_hash ON b_crm_repeat_sale_queue (job_id, hash);

CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_log (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  JOB_ID int NOT NULL,
  SEGMENT_ID int NOT NULL,
  ENTITY_TYPE_ID int NOT NULL,
  ENTITY_ID int NOT NULL,
  STAGE_SEMANTIC_ID varchar(1) NOT NULL DEFAULT 'P',
  CREATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UPDATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (ID)
);
CREATE INDEX ix_b_crm_repeat_sale_log_job_id ON b_crm_repeat_sale_log (job_id);
CREATE INDEX ix_b_crm_repeat_sale_log_segment_id ON b_crm_repeat_sale_log (segment_id);
CREATE INDEX ix_b_crm_repeat_sale_log_entity_type_id ON b_crm_repeat_sale_log (entity_type_id);
CREATE INDEX ix_b_crm_repeat_sale_log_entity_type_id_entity_id ON b_crm_repeat_sale_log (entity_type_id, entity_id);
CREATE INDEX ix_b_crm_repeat_sale_log_segment_id_stage_semantic_id ON b_crm_repeat_sale_log (segment_id, stage_semantic_id);

CREATE TABLE IF NOT EXISTS b_crm_repeat_sale_segment_assignment_user (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  SEGMENT_ID int NOT NULL,
  USER_ID int NOT NULL,
  PRIMARY KEY (ID)
);
CREATE INDEX ix_b_crm_repeat_sale_segment_assignment_user_segment_id_user_id ON b_crm_repeat_sale_segment_assignment_user (segment_id, user_id);

CREATE TABLE IF NOT EXISTS b_crm_ai_queue_buffer (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  PROVIDER_ID int NOT NULL,
  STATUS int NOT NULL,
  PROVIDER_DATA text,
  PROVIDER_DATA_HASH varchar(32) NOT NULL,
  RETRY_COUNT int NOT NULL DEFAULT 0,
  CREATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  UPDATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CREATED_BY_ID int NOT NULL DEFAULT 0,
...
CREATE INDEX ix_b_crm_ai_queue_buffer_provider_id_provider_data_hash ON b_crm_ai_queue_buffer (provider_id, provider_data_hash);
CREATE INDEX ix_b_crm_ai_queue_buffer_created_at ON b_crm_ai_queue_buffer (created_at);
