...
$MESS["CRM_KANBAN_ACTIVITY_CHANGE_QUOTE_MSGVER_2"] = "You don't have any scheduled activities. <span class=\"crm-kanban-item-activity-link\">Plan</span> your next action on the estimate to never forget about the customer.";
...
$MESS["CRM_KANBAN_MASS_CONVERT_DISABLE_MSGVER_1"] = "Bulk move to this stage is currently unavailable.";
...
$MESS["CRM_KANBAN_NOTIFY_DYNAMIC_STATUS_MSGVER_1"] = "Entities moved to stage: #statusName#.";
...
$MESS["CRM_KANBAN_NOTIFY_INVOICE_STATUS_MSGVER_1"] = "Invoices moved to stage: #statusName#.";
...
$MESS["CRM_KANBAN_NOTIFY_LEAD_STATUS_MSGVER_1"] = "Leads moved to stage: #statusName#.";
$MESS["CRM_KANBAN_NOTIFY_OUTDATED_DATA"] = "Data on this page is out of date. Please refresh the page.";
$MESS["CRM_KANBAN_NOTIFY_QUOTE_DELETE_MSGVER_1"] = "Estimates deleted.";
...
$MESS["CRM_KANBAN_PLUS_TITLE_SMART_B2E_DOC"] = "HR document";
...
$MESS["CRM_KANBAN_SET_STATUS_NOT_COMPLETED_TEXT_DEAL_MSGVER_1"] = "Some of the deals cannot be moved to the selected stage. Please complete the required fields and try again.";
$MESS["CRM_KANBAN_SET_STATUS_NOT_COMPLETED_TEXT_DYNAMIC_MSGVER_1"] = "Some of the entities cannot be moved to the selected stage. Please complete the required fields and try again.";
$MESS["CRM_KANBAN_SET_STATUS_NOT_COMPLETED_TEXT_INVOICE_MSGVER_1"] = "Some of the invoices cannot be moved to the selected stage. Please complete the required fields and try again.";
$MESS["CRM_KANBAN_SET_STATUS_NOT_COMPLETED_TEXT_LEAD_MSGVER_1"] = "Some of the leads cannot be moved to the selected stage. Please complete the required fields and try again.";
$MESS["CRM_KANBAN_SET_STATUS_NOT_COMPLETED_TEXT_QUOTE_MSGVER_2"] = "Some of the estimates cannot be moved to the selected stage. Please complete the required fields and try again.";
