/**
 * @module layout/ui/email-input-box-old
 */
jn.define('layout/ui/email-input-box-old', (require, exports, module) => {
	...
	const { EmailInput } = require('layout/ui/email-input-box-old/src/email-input');
	...
	class EmailInputBoxOld extends LayoutComponent
	{
		constructor(props)
		{
			super(props);
	 ...
	 * @return {Promise}
	 */
	const openEmailInputBoxOld = (props) => {
		return new Promise((resolve) => {
			const parentLayout = props.parentLayout || PageManager;
			const controlInstance = new EmailInputBoxOld(props);
