...
$MESS["HINT_TASK_ASSIGNEE_CHECKLIST_EDIT"] = "Edit all items in a checklist. Assignee can open and close checklist items irrespective of this option.";
$MESS["HINT_TASK_ASSIGNEE_DELEGATE"] = "By default, tasks can be delegated to subordinate employees. User can delegate tasks to supervisors or employees of other departments if this user has a task assign permission.";
$MESS["HINT_TASK_ASSIGNEE_EDIT"] = "Supervisor inherits their employees' task edit permission. Supervisor can edit their task if it was assigned to them by their employee.";
