...
(function (exports,ui_navigationpanel,ui_shortView,ui_entitySelector,ui_hint,main_polyfill_intersectionobserver,main_popup,ui_dialogs_messagebox,ui_draganddrop_draggable,pull_client,main_loader,ui_analytics,main_core,main_core_events,ui_buttons) {
	...
	var Plan = /*#__PURE__*/function (_View) {
	  ...
	  babelHelpers.createClass(Plan, [{
	    ...
	    value: function onShowLinked(baseEvent) {
	      var _this16 = this;
	      var baseItem = baseEvent.getData();
	      if (this.searchItems.isActive()) {
	        this.searchItems.stop();
	        return;
	      }
	      ...
	      this.requestSender.showLinkedTasks({
	        ...
	        var items = new Set();
	        var itemIds = [];
	        itemsData.forEach(function (itemParams) {
	          var item = Item.buildItem(itemParams);
	        ...
	        if (items.size > 0) {
	          _this16.searchItems.start(baseItem, itemIds);
	        } else {
	...
	var RobotButton = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  function RobotButton(params) {
	    ...
	    _this.isAutomationEnabled = params.isAutomationEnabled;
	...
	var ActiveSprint = /*#__PURE__*/function (_View) {
	  ...
	  babelHelpers.createClass(ActiveSprint, [{
	    ...
	    key: "checkIsAutomationEnabled",
	    value: function checkIsAutomationEnabled() {
