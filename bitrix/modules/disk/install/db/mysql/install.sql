...
(
	...
	KEY IX_DISK_SR_1 (OBJECT_ID, ACCESS_CODE),
...
(
    ...
    KEY IX_DISK_TSR_1 (SESSION_ID, OBJECT_ID)
);
...
CREATE TABLE IF NOT EXISTS b_disk_document_session
(
	ID int not null auto_increment,
...
CREATE TABLE IF NOT EXISTS b_disk_document_restriction_log
(
	ID int not null auto_increment,
	SERVICE VARCHAR(50) NULL DEFAULT NULL,
	USER_ID int not null,
