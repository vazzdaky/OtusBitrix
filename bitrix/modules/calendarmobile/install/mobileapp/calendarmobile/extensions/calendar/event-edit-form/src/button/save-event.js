/**
 * @module calendar/event-edit-form/button/save-event
 */
jn.define('calendar/event-edit-form/button/save-event', (require, exports, module) => {
			...
			return new Promise((resolve, reject) => {
				dispatch(
					saveEvent({
						...
						data: fields,
						reduxFields: State.getReduxFields(),
						initialReduxFields: State.getInitialReduxFields(),
						resolve,
						reject,
					}),
				);
