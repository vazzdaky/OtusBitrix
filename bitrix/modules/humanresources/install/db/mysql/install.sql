...
(
	...
	INDEX IX_B_HR_STRUCTURE_NODE_MEMBER_ROLE_ROLE_ID (ROLE_ID),
...
(
	...
	`CREATED_AT` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	`UPDATED_AT` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	INDEX IX_B_HR_STRUCTURE_NODE_SETTINGS (NODE_ID, SETTINGS_TYPE)
);
...
CREATE TABLE IF NOT EXISTS  `b_hr_structure_node_path` (
	...
	INDEX IX_B_HR_STRUCTURE_NODE_PATH_CHILD_PARENT (`CHILD_ID`, `PARENT_ID`),
