...
/**
 * @module im/messenger/model/dialogues/collab/model
 */
jn.define('im/messenger/model/dialogues/collab/model', (require, exports, module) => {
	const { Type } = require('type');
	const { collabDefaultElement } = require('im/messenger/model/dialogues/collab/default-element');

	const { validateEntities, validateSetCounterPayload, validateSetGuestCountPayload } = require('im/messenger/model/dialogues/collab/validator');
