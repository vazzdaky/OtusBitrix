/**
 * @module im/messenger/provider/services/analytics/message-delete
 */
jn.define('im/messenger/provider/services/analytics/message-delete', (require, exports, module) => {
