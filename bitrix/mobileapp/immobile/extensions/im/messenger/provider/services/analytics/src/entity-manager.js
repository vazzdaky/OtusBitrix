/**
 * @module im/messenger/provider/services/analytics/entity-manager
 */
jn.define('im/messenger/provider/services/analytics/entity-manager', (require, exports, module) => {
