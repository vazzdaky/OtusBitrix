/**
 * @module im/messenger/controller/sidebar-v2/tabs/audio/src/action-menu
 */
jn.define('im/messenger/controller/sidebar-v2/tabs/audio/src/action-menu', (require, exports, module) => {
	...
	module.exports = { AudioActionMenu };
});
